...
const aiCategories = [
  { 
    name: 'Obstacle Avoid Auto', 
    image: require('../ai_activities/ai_images/CameraBase(1).jpg'), 
    screen: 'SensorControl',
    description: 'Autonomous navigation with smart detection',
    color: '#FF6B6B',
    accent: '#FF5252',
    icon: '🤖'
  },
  { 
    name: 'Obstacle Avoid Manual', 
    image: require('../ai_activities/ai_images/voiceBase(1).jpg'), 
    screen: 'dpadControl',
    description: 'Manual control with obstacle assistance',
    color: '#4ECDC4',
    accent: '#26A69A',
    icon: '🎮'
  },
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerTop}>
          <View>
            <Text style={styles.welcomeText}>AI Intelligence</Text>
            {/* <Text style={styles.headerTitle}>Smart Activities</Text> */}
          </View>
